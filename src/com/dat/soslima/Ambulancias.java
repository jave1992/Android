...
public class Ambulancias extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ambulancias_layout);
		
		ActionBar actionBar=getActionBar();
		actionBar.setDisplayHomeAsUpEnabled(true);
		
		lv=(ListView)findViewById(R.id.listViewAmbulancias);
		editText=(EditText)findViewById(R.id.edAmbulancia);
		
		UtilDB db = UtilDB.GetUtilDb(this);
		db.openDataBase();
		Cursor c=db.getDataBase().rawQuery("SELECT * FROM ambulancia",null);
		...
		if(c.moveToFirst()){
		    ...
		    editText.addTextChangedListener(new TextWatcher(){
				...
				public void onTextChanged(CharSequence s, int start,
					...
					lv.setAdapter(new AdapterTitulo(Ambulancias.this,lista2));
				}
		    });
		}
	}
